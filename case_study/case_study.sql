...
insert into nhan_vien(ho_va_ten, ngay_sinh, so_cmnd, luong, so_dien_thoai, email, dia_chi, ma_vi_tri, ma_trinh_do,
                      ma_bo_phan)
...
select hd.ma_hop_dong,
       hd.ngay_lam_hop_dong,
       hd.ngay_ket_thuc,
       group_concat(dvdk.ten_dich_vu_di_kem),
       hd.tien_dat_coc,
