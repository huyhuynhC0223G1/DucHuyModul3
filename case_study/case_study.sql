...
values ("massage", 500000, "giờ", "Tốt"),
 ("karaoke", 100000, "giờ", "Tốt"),
 ("buffet", 500000, "suất", "Tốt"),
 ("thuê xe di chuyển tham quan resort", 200000, "chiếc", "Tốt");
...
from khach_hang kh
left join hop_dong dh on dh.ma_khach_hang = kh.ma_khach_hang
